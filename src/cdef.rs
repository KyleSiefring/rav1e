...
pub(crate) mod native {
  ...
  pub fn cdef_find_dir<T: Pixel>(
    img: &PlaneSlice<'_, u16>, var: &mut u32, coeff_shift: usize, _cpu: CpuFeatureLevel,
  ) -> i32 {
...
pub fn cdef_analyze_superblock_range<T: Pixel>(
  fi: &FrameInvariants<T>, in_frame: &Frame<u16>, blocks: &TileBlocks<'_>, sbo: TileSuperBlockOffset,

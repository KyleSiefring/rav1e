          ...
          for y in 0..4 {
            for x in 0..4 {
              ...
              let (vertical_candidate_1, vertical_candidate_2) = match (x, y) {
                ...
                (0..=1, 2) => (pmvs_s[0][r], half_res_pmvs_this_block[1][r]),
                (2..=3, 2) => (pmvs_s[0][r], half_res_pmvs_this_block[2][r]),
              ...
              let (horizontal_candidate_1, horizontal_candidate_2) =
                match (x, y) {
                  ...
                  (2, 0..=1) => (pmvs_e[0][r], half_res_pmvs_this_block[1][r]),
                  (2, 2..=3) => (pmvs_e[0][r], half_res_pmvs_this_block[3][r]),

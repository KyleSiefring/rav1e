          ...
          for y in 0..4 {
            for x in 0..4 {
              ...
              let (vertical_candidate_1, vertical_candidate_2) = match (x, y) {
                (0..=1, 0) => (None, half_res_pmvs_this_block[3][r]),
                (2..=3, 0) => (None, half_res_pmvs_this_block[4][r]),
                (0..=1, 1) => (None, None),
                (2..=3, 1) => (None, None),
              ...
              let (horizontal_candidate_1, horizontal_candidate_2) =
                match (x, y) {
                  (0, 0..=1) => (None, half_res_pmvs_this_block[2][r]),
                  (0, 2..=3) => (None, half_res_pmvs_this_block[4][r]),
                  (1, 0..=1) => (None, None),
                  (1, 2..=3) => (None, None),

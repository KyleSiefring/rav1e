...
fn apply_speed_test_cfg(cfg: &mut EncoderConfig, setting: &str) {
  match setting {
    ...
    "min_block_size_8x8" => {
      cfg.speed_settings.block_size_range = (BlockSize::BLOCK_8X8, BlockSize::BLOCK_64X64);
    }
    "min_block_size_16x16" => {
      cfg.speed_settings.block_size_range = (BlockSize::BLOCK_16X16, BlockSize::BLOCK_64X64);
    }
    "min_block_size_32x32" => {
      cfg.speed_settings.block_size_range = (BlockSize::BLOCK_32X32, BlockSize::BLOCK_64X64);
    }
    "min_block_size_64x64" => {
      cfg.speed_settings.block_size_range = (BlockSize::BLOCK_64X64, BlockSize::BLOCK_64X64);
    }
    "no_multiref" => {

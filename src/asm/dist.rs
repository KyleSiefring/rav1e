...
pub fn get_sad<T: Pixel>(
  ...
  bsize: BlockSize, bit_depth: usize, cpu: CpuFeatureLevel
) -> u32 {
  let call_native = || -> u32 {
    native::get_sad(dst, src, bsize, bit_depth, cpu)
  };
...
mod x86_64 {
  ...
  pub static SAD_FNS: [[Option<SadFn>; DIST_FNS_LENGTH]; CpuFeatureLevel::len()] = {
  ...
  pub static SAD_HBD_FNS: [[Option<SadHBDFn>; DIST_FNS_LENGTH]; CpuFeatureLevel::len()] = {
    let mut out = [[None; DIST_FNS_LENGTH]; CpuFeatureLevel::len()];

...
#[$m]
pub $($s)* fn fidentity4<T: TxOperations>(coeffs: &mut [T]) {
}

#[$m]
pub $($s)* fn fidentity8<T: TxOperations>(coeffs: &mut [T]) {
}

#[$m]
$($s)* fn fidentity16<T: TxOperations>(coeffs: &mut [T]) {
}

#[$m]
$($s)* fn fidentity32<T: TxOperations>(coeffs: &mut [T]) {
}
